  ...
  createRoutesFromElements(
    <>
      ...
      <Route
        path="/"
        element={
          <ErrorBoundary fallback={({ error, reset }) => <Error error={error} reset={reset} />}>
            <RootLayout />
          </ErrorBoundary>
        }
      >
        ...
        <Route
          path="*"
          lazy={async () => {
            const { default: NotFound } = await import('../pages/not-found/not-found.tsx')
      ...
      >
        ...
        >
          ...
          <Route
            path=":id"
            lazy={async () => {
              const { default: UserDetails } = await import('./admin/users/[id]/user')
          ...
          <Route
            path="create"
            lazy={async () => {
              const { default: CreateUserPage } = await import('./admin/users/create/create-user')
        ...
        <Route
          path="bookings"
          lazy={async () => {
            const { default: BookingsLayout } = await import('./admin/bookings')
        ...
        >
          <Route
            index
            lazy={async () => {
              const { default: BookingsPage } = await import('./admin/bookings/bookings')
